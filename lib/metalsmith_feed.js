...
module.exports = function(options) {
  ...
  return function(files, metalsmith, done) {
    var collection, feed, feedOptions, file, i, itemData, len, metadata, ref, ref1, ref2, siteUrl;
    ...
    for (i = 0, len = collection.length; i < len; i++) {
      ...
      if (file.featuredImage) {
        itemData.custom_elements = [
          {
            'media:image': ((ref1 = metadata.site) != null ? ref1.url : void 0) + file.featuredImage
          }, {
            'media:thumbnail': ((ref2 = metadata.site) != null ? ref2.url : void 0) + file.featuredImage
          }
        ];
      }
